/**
 * File Name: ThermostatNight.java<br>
 ...
 * <p>
 * Methods to perform core action of setting the thermostat to night setting and
...
public class ThermostatNight extends Event implements Serializable {
	 ...
	 */
	public ThermostatNight(GreenhouseControls controller, long delayTime) {
	...
	public void action() {
		...
		getController().setThermostat("Night");
	}
